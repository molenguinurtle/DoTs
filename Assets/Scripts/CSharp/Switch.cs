...
public abstract class Switch : MonoBehaviour
{
    ...
    protected GameObject _switchOccupant; //This is the player that stepped on the Switch. Used to determine if we should activate the Switch again once it's stepped off of
